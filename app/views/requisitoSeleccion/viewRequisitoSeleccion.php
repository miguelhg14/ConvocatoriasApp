    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="container">
                    ...
                    <a href="/requisitoSeleccion/new" class="btn btn-primary mb-3">
                    ...
                    <!-- Lista de registros -->
                    <?php if (isset($requisitos) && is_array($requisitos) && count($requisitos) > 0): ?>
            <div class="list-group">
                <?php foreach ($requisitos as $requisito): ?>
                    <div class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                        <div>
                            <span class="fw-bold"><?= htmlspecialchars($requisito->id) ?> - <?= htmlspecialchars($requisito->nombre) ?></span>
                            <span class="d-block text-muted">Tipo: <?= htmlspecialchars($requisito->nombre_tipo ?? 'No especificado') ?></span>
                        </div>
                        <div class="btn-group">
                            <a href="/requisitoSeleccion/view/<?= $requisito->id ?>" class="btn btn-sm btn-info">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="/requisitoSeleccion/edit/<?= $requisito->id ?>" class="btn btn-sm btn-warning">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a href="/requisitoSeleccion/deleteRequisitoSeleccion/<?= $requisito->id ?>" 
        ...
        <?php else: ?>
            <div class="alert alert-info">
                ...
                No hay requisitos de selección registrados.
            </div>
        <?php endif; ?>
                </div>
            </div>
