...
<head>
    ...
    <title>Portal de Talento SENA</title>
...
<header>
    <div class="logo">
        <img src="/img/sena2.jpg" alt="SENA Logo" loading="lazy">
    </div>
    <div class="user-profile">
        <ul>
            <li><a href="/convocatoria/init"><i class="fas fa-chalkboard-teacher"></i><span> Crear Convocatorias</span></a></li>
            <li><a href="/administrarUsuario/init"><i class="fas fa-users"></i><span>administrar Usuario</span></a></li>
            <li><a href="/userPerfil/init"><i class="fas fa-user-circle"></i> <!-- Ícono de perfil --><span>Perfil Usuario</span></a></li>
        </ul>
        <div class="user-name">Cerrar Sesión</div>
    </div>
</header>
...
<div class="container">
    <!-- Banner principal -->
    <div class="main-banner">
        <img src="/img/image.png" class="banner-image" alt="Impulsa tu talento" loading="lazy">
        <div class="banner-content">
            <h1>Impulsa tu Talento 2025</h1>
            <br><br>
            <pre>Oportunidad única para desarrollar
...
¡inscríbete y crece profesionalmente!</pre>
    ...
    <div class="discover-section">
        ...
        <div class="cards-container">
            <div class="card">
                <div class="card-image">
                    <img src="/img/sena2.jpg" alt="Convocatoria de Reclutamiento" loading="lazy">
                </div>
                <div class="card-content">
                    <div class="card-category">Recursos Humanos</div>
                    <div class="card-title">Convocatoria de Reclutamiento</div>
            ...
            <div class="card">
                <div class="card-image">
                    <img src="/img/sena2.jpg" alt="Tu Futuro Profesional" loading="lazy">
                </div>
                <div class="card-content">
                    <div class="card-category">Desarrollo Personal</div>
                    <div class="card-title">Tu Futuro Profesional Comienza Aquí</div>
            ...
            <div class="card">
                <div class="card-image">
                    <img src="/img/image.png" alt="Bolsa de Empleo" loading="lazy">
                </div>
                <div class="card-content">
                    <div class="card-category">Empleo</div>
                    <div class="card-title">Bolsa de Empleo Abierta</div>
            ...
            <div class="card">
                <div class="card-image">
                    <img src="/img/SENA.jpg" alt="Analiza y Elige la Mejor Oferta" loading="lazy">
                </div>
                <div class="card-content">
                    <div class="card-category">Análisis Mercado</div>
                    <div class="card-title">Analiza y Elige la Mejor Oferta</div>
            ...
            <div class="card">
                <div class="card-image">
                    <img src="/img/sena2.jpg" alt="Oportunidades Laborales" loading="lazy">
                </div>
                <div class="card-content">
                    <div class="card-category">Empleo</div>
                    <div class="card-title">Oportunidades Laborales Disponibles</div>
