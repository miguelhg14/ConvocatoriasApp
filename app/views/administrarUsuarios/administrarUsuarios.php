  ...
  <div class="bg-success bg-opacity-25 border-bottom border-success border-opacity-25">
    <div class="container px-4 py-2">
      <div class="d-flex align-items-center">
        ...
        <span class="ms-auto badge bg-success bg-opacity-10 text-success border border-success px-3 py-1">4 Usuarios</span>
      </div>
    </div>
  </div>
    ...
    <ul class="nav nav-tabs mb-3" id="userTabs" role="tablist">
      ...
      <li class="nav-item flex-fill text-center" role="presentation">
        <button class="nav-link w-100" id="suspended-tab" data-bs-toggle="tab" data-bs-target="#suspended-tab-pane"
          type="button" role="tab" aria-controls="suspended-tab-pane" aria-selected="false">Suspendidos</button>
      </li>
    </ul>
              ...
              <div class="row align-items-center">
                ...
                <div class="col-md-7 col-sm-10">
                  <div class="d-flex flex-wrap align-items-center gap-2 mb-1">
                    <h5 class="card-title mb-0 fs-6">María López</h5>
...
<div class="modal fade" id="newUserModal" tabindex="-1" aria-labelledby="newUserModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <!-- Formulario dentro del modal -->
        <form id="nuevoUserForm" action="/administrarUsuario/init" method="post" enctype="multipart/form-data">
          <div class="mb-3">
            <label for="nuevoTxtNombre" class="form-label">
              <i class="fas fa-user me-2"></i> Nombre
            </label>
            <input type="text" class="form-control" id="nuevoTxtNombre" name="txtNombre" placeholder="Ingrese su nombre" required>
          </div>
          <div class="mb-3">
            <label for="nuevoTxtApellido" class="form-label">
              <i class="fas fa-user-tag me-2"></i> Apellido
            </label>
            <input type="text" class="form-control" id="nuevoTxtApellido" name="txtApellido" placeholder="Ingrese su apellido" required>
          </div>
          <div class="mb-3">
            <label for="nuevoTxtEmail" class="form-label">
              <i class="fas fa-envelope me-2"></i> Correo electrónico
            </label>
            <input type="email" class="form-control" id="nuevoTxtEmail" name="txtEmail" placeholder="Ingrese su correo" required>
          </div>
          <div class="mb-3">
            <label for="nuevoTxtPassword" class="form-label">
              <i class="fas fa-lock me-2"></i> Contraseña
            </label>
            <input type="password" class="form-control" id="nuevoTxtPassword" name="txtPassword" placeholder="Ingrese su contraseña" required>
          </div>
        </form>
      </div>
      <div class="modal-footer">
