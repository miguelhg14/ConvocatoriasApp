...
-->
        ...
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body p-0">
                <div class="position-relative">
                    <img src="/img/image.png?height=150&width=200" class="card-img-top bg-light" alt="Desarrollo Web">
    ...
    <div class="col-md-4 mb-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body p-0">
                <div class="position-relative">
                    <img src="/img/image.png?height=100&width=200" class="card-img-top bg-light" alt="Análisis de Datos">
    ...
    <div class="col-md-4 mb-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body p-0">
                <div class="position-relative">
                    <img src="/img/image.png?height=150&width=200" class="card-img-top bg-light" alt="Ciberseguridad">
...
<!-- Tarjetas de cursos - Primera fila -->
    ...
    <div class="col-md-6 mb-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body p-0">
                <div class="position-relative">
                    <img src="/img/image.png" class="card-img-top object-fit-cover" alt="Desarrollo Web" style="height: 150px;">
                    <span class="badge bg-success position-absolute top-0 end-0 m-2">Nuevo</span>
                </div>
                <div class="p-2">
                    <h5 class="card-title fs-6">Técnico en Desarrollo de Aplicaciones Web</h5>
                    <p class="card-text text-muted small">Aprende a crear aplicaciones web modernas con las tecnologías más demandadas del mercado.</p>
    ...
    <div class="col-md-6 mb-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body p-0">
                <div class="position-relative">
                    <img src="/img/image.png" class="card-img-top object-fit-cover" alt="Análisis de Datos" style="height: 150px;">
                </div>
                <div class="p-2">
                    <h5 class="card-title fs-6">Tecnólogo en Análisis de Datos</h5>
                    <p class="card-text text-muted small">Conviértete en un experto en análisis de datos y business intelligence.</p>
                    <div class="d-flex justify-content-between align-items-center mt-2">
                        <div>
                            <i class="far fa-clock text-muted me-1"></i>
    ...
    <div class="col-md-6 mb-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body p-0">
                <div class="position-relative">
                    <img src="/img/image.png" class="card-img-top object-fit-cover" alt="Ciberseguridad" style="height: 150px;">
                    <span class="badge bg-success position-absolute top-0 end-0 m-2">Popular</span>
                </div>
                <div class="p-2">
                    <h5 class="card-title fs-6">Especialización en Ciberseguridad</h5>
                    <p class="card-text text-muted small">Protege sistemas y redes con las técnicas más avanzadas de seguridad informática.</p>
                    <div class="d-flex justify-content-between align-items-center mt-2">
                        <div>
                            <i class="far fa-clock text-muted me-1"></i>
    ...
    <div class="col-md-6 mb-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body p-0">
                <div class="position-relative">
                    <img src="/img/image.png" class="card-img-top object-fit-cover" alt="Marketing Digital" style="height: 150px;">
                </div>
                <div class="p-2">
                    <h5 class="card-title fs-6">Técnico en Marketing Digital</h5>
