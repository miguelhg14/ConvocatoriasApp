                            ...
                            <tbody>
                                <?php foreach ($publicosObjetivo as $publicoObjetivo) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/publicoObjetivo/view/<?= $publicoObjetivo->id ?>" class="btn btn-info btn-sm">
                                                <i class="fas fa-eye me-1"></i> Ver
                                            </a>
                                            <a href="/publicoObjetivo/edit/<?= $publicoObjetivo->id ?>" class="btn btn-success btn-sm">
                                                <i class="fas fa-edit me-1"></i> Editar
                                            </a>
                                            <a href="/publicoObjetivo/delete/<?= $publicoObjetivo->id ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Está seguro de eliminar este registro?')">
