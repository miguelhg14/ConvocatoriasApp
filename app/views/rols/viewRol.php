            ...
            <div class="col-md-10">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">
                            Lista de Roles
                            <a href="/rol/new" class="btn btn-light float-end">
                ...
                <tbody>
                    <?php foreach ($roles as $value): ?>
                        <tr>
                            ...
                            <td>
                                <a href="/rol/view/<?php echo $value->id; ?>" class="btn btn-info btn-sm">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="/rol/edit/<?php echo $value->id; ?>" class="btn btn-primary btn-sm">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="/rol/delete/<?php echo $value->id; ?>" class="btn btn-danger btn-sm" 
