...
<div class="card-body p-0">
    <div class="list-group list-group-flush">
        ...
        <a href="/entidadInstitucion/init" class="list-group-item list-group-item-action active d-flex align-items-center">
        ...
        <a href="/convocatoria/lista" class="list-group-item list-group-item-action d-flex align-items-center">
            ...
            <div class="col-md-10">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">Entidades Institución
                            <a href="/entidadInstitucion/new" class="btn btn-light float-end">
                            ...
                            <div class="list-group">
                                <?php foreach ($entidadInstituciones as $key => $value): ?>
                                    <div class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="btn-group">
                                            <a href="/entidadInstitucion/view/<?= $value->id ?>" class="btn btn-sm btn-info">
                                                <i class="fas fa-eye me-1"></i> Ver
                                            </a>
                                            <a href="/entidadInstitucion/edit/<?= $value->id ?>" class="btn btn-sm btn-success">
                                                <i class="fas fa-edit me-1"></i> Editar
                                            </a>
                                            <a href="/entidadInstitucion/delete/<?= $value->id ?>" class="btn btn-sm btn-danger" onclick="return confirm('¿Está seguro de eliminar este registro?')">
